...
<head>
    ...
    <link href="<?php echo base_url('assets/iziToast-master/dist/css/iziToast.min.css'); ?>" rel="stylesheet">

    <!-- <link rel="stylesheet" href="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/css/alertify.min.css" /> -->

    <link href="<?php //echo base_url('assets/vendor/simple-datatables/style.css'); 
                ?>" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="<?php echo base_url('assets/css/style.css'); ?>" rel="stylesheet">
    <link href="<?php //echo base_url('assets/css/choices.min.js.css'); ?>" rel="stylesheet">
    ...
    <style>
        ...
        */
        ...
        .dataTables_wrapper .dataTables_paginate .paginate_button:hover {
            ...
            background-color: #a7aac0 !important;
            color: #fff !important;
        }
    </style>
    <!-- <script>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <i class="bi bi-chevron-double-left toggle-sidebar-btn" id='1' style="transition-duration: 0.2s;" onclick="changeIcon(this)"></i>
        <div class="d-flex align-items-center justify-content-between">

            <a tabindex="-1" href="<?php echo base_url() ?>/dashboard" class="logo d-flex align-items-center">
                <img src="<?php echo base_url('assets/img/smt-logo.png'); ?>" alt="Logo" height="90px" />
                <span class="d-none d-lg-block">Shri Mahalaxmi Transport</span>
            </a>
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a tabindex="-1" class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                        <li class="dropdown-header">
                            ...
                            <a tabindex="-1" href="#"><span class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
                        </li>
                        <li>
                        ...
                        <li class="dropdown-footer">
                            <a tabindex="-1" href="#">Show all notifications</a>
                        </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="dropdown-footer">
                            <a tabindex="-1" href="#">Show all messages</a>
                        </li>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a tabindex="-1" class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <?php $this->rendersection('profilename') ?>
                ...
                <li>
                    <a tabindex="-1" class="dropdown-item d-flex align-items-center" href="<?= base_url() ?>/userprofile">
                ...
                <!-- <li>
            <a tabindex="-1" class="dropdown-item d-flex align-items-center" href="users-profile.html">
                ...
                <li>
                    <a tabindex="-1" class="dropdown-item d-flex align-items-center" href="#">
                ...
                <li>
                    <a tabindex="-1" class="dropdown-item d-flex align-items-center" href="<?= base_url() ?>/trpadmin/trpadmin/logout">
    ...
    <aside id="sidebar" class="sidebar" style="background-color: #012970;">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a tabindex="-1" class="nav-link " href="<?php echo base_url() ?>/dashboard">
            ...
            <li class="nav-item">
                <a tabindex="-1" id="biltya" class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Bilty</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a tabindex="-1" id="nbilty" href="<?php echo base_url() ?>/newbilty">
                            <i class="bi bi-circle"></i><span>New Bilty</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="#">
                            <i class="bi bi-circle"></i><span>Upadate Bilty</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="#">
                            <i class="bi bi-circle"></i><span>Receiving Bilty</span>
                        </a>
                    </li>
                    <!-- <li>
                        <a tabindex="-1" href="components-breadcrumbs.html">
                            <i class="bi bi-circle"></i><span>Breadcrumbs</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-buttons.html">
                            <i class="bi bi-circle"></i><span>Buttons</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-cards.html">
                            <i class="bi bi-circle"></i><span>Cards</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-carousel.html">
                            <i class="bi bi-circle"></i><span>Carousel</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-list-group.html">
                            <i class="bi bi-circle"></i><span>List group</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-modal.html">
                            <i class="bi bi-circle"></i><span>Modal</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-tabs.html">
                            <i class="bi bi-circle"></i><span>Tabs</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-pagination.html">
                            <i class="bi bi-circle"></i><span>Pagination</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-progress.html">
                            <i class="bi bi-circle"></i><span>Progress</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-spinners.html">
                            <i class="bi bi-circle"></i><span>Spinners</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="components-tooltips.html">
            ...
            <li class="nav-item">
                <a tabindex="-1" id="master" class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-text"></i><span>Masters</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a tabindex="-1" id="noradd" href="<?php echo base_url() ?>/consignor">
                            <i class="bi bi-circle"></i><span>Consignor</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="#">
                    ...
                    <li>
                        <a id="citya" tabindex="-1" href="<?php echo base_url() ?>/city">
                            <i class="bi bi-circle"></i><span>City</span>
                        </a>
                    </li>
                    <li>
                        <a id="cquot" tabindex="-1" href="<?php echo base_url() ?>/quotation">
                            <i class="bi bi-circle"></i><span>Create Quotation</span>
                        </a>
                    </li>
                    <li>
                        <a id="aquot" tabindex="-1" href="<?php echo base_url() ?>/assignQuot">
                            <i class="bi bi-circle"></i><span>Assign Quotaion to Consignor</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Forms Nav -->
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Tables</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a tabindex="-1" href="tables-general.html">
                            <i class="bi bi-circle"></i><span>General Tables</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="tables-data.html">
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-bar-chart"></i><span>Charts</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a tabindex="-1" href="charts-chartjs.html">
                            <i class="bi bi-circle"></i><span>Chart.js</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="charts-apexcharts.html">
                            <i class="bi bi-circle"></i><span>ApexCharts</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="charts-echarts.html">
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-gem"></i><span>Icons</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a tabindex="-1" href="icons-bootstrap.html">
                            <i class="bi bi-circle"></i><span>Bootstrap Icons</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="icons-remix.html">
                            <i class="bi bi-circle"></i><span>Remix Icons</span>
                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="icons-boxicons.html">
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" href="users-profile.html">
                    <i class="bi bi-person"></i>
                    <span>Profile</span>
                </a>
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" href="pages-faq.html">
                    <i class="bi bi-question-circle"></i>
                    <span>F.A.Q</span>
                </a>
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" href="pages-contact.html">
            ...
            <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" href="<?php echo base_url() ?>/register">
            ...
            <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" href="<?php echo base_url() ?>/loginactivity">
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" href="pages-error-404.html">
            ...
            <!-- <li class="nav-item">
                <a tabindex="-1" class="nav-link collapsed" href="pages-blank.html">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Krushna Logitech</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            ...
            Designed & Developed by <a tabindex="-1">Krushna Khile</a>
        </div>
    </footer><!-- End Footer -->
    <a tabindex="-1" href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- Modal Header -->
                <div class="modal-header" style="background-color:#012970 ;">
                    <h4 id="norhead" class="modal-title" style="color:#fff ;">Add Consignor Details</h4>
                    <button type="button" class="fa-solid fa-xmark" style="color:#fff ;" data-bs-dismiss="modal"></button>
                </div>
...
<input type="hidden" id="editid">
                        <div class="form-group col-md-8">
                            <label for="inputText" class="col-form-label"><b>Consignor Name :</b></label>
                            <input type="text" class="form-control fw-semibold norname" placeholder="Enter Consignor Name">
                            <b><span id="error_name" class="text-danger ms-3"></span></b>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputText" class="col-form-label"><b>Short Code :</b></label>
                            <input type="text" class="form-control fw-semibold norshort" placeholder="Enter  Short Code">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputText" class="col-form-label"><b>Email :</b></label>
                            <input type="email" class="form-control fw-semibold noremail" placeholder="Enter Email">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputText" class="col-form-label"><b>Contact No. :</b></label>
                            <input type="number" class="form-control fw-semibold normobile" placeholder="Enter  Contact No.">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputText" class="col-form-label"><b>GSTIN :</b></label>
                            <input type="text" min="0" class="form-control fw-semibold norgstin" placeholder="Enter Pincode">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputText" class="col-form-label"><b>City :</b></label><b><span id="error_city" class="text-danger ms-3"></span></b>
                            <select id="error_city" name="name2" class="form-select form-control fw-semibold norcity" aria-label="Default select example">
                        ...
                        <div class="form-group col-md-4">
                            <label for="inputText" class="col-form-label"><b>Mode of Payment :</b></label>
                            <select id="id2" name="name2" class="form-select form-control fw-semibold norpayment" aria-label="Default select example">
                            ...
                            <b><span id="error_payment" class="text-danger ms-3"></span></b>
                        </div>
                ...
                <!-- Modal footer -->
                <div class="modal-footer" style="background-color:#012970 ;">
                    <button type="button" class="btn btn-primary norsave" onclick="addNor();" value="Save"><i class="fa-solid fa-check"></i> Save</button>
    ...
    <!-- <script src="C:\xampp\htdocs\trp\public\assets\js\jquery.js"></script> -->
    ...
    <?php $this->rendersection('script1') ?>
            ...
            return function t(e, s, i) {
                ...
                2: [function(t, e, s) {
                    ...
                    const i = t => "[object Object]" === Object.prototype.toString.call(t),
                        ...
                        r = (t, e, s) => a("li", {
                            class: t,
                            html: `<a tabindex="-1" href="#" data-page="${e}">${s}</a>`
                        }),
                        o = (t, e) => {
                            let s, i;
    ...
    <script src="<?php //echo base_url('js/datatables-simple-demo.js'); 
                    ?>"></script>
    <script>
        // document.body.style.zoom = "85%";
        if ($(window).width() < 1199) {
            $('#1').attr('class', 'bi bi-list toggle-sidebar-btn')
            $('#1').attr('id', '0')
        }
        ...
        const changeIcon = (data) => {
            if ($(data).attr('id') == '1') {
                $(data).attr('id', '0')
                $(data).attr('class', 'bi bi-list toggle-sidebar-btn')
            } else {
                $(data).attr('id', '1')
                $(data).attr('class', 'bi bi-chevron-double-left toggle-sidebar-btn')
            }
