    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="dashboard" class="logo d-flex align-items-center">
                <img src="<?php echo base_url('assets/img/truck.png'); ?>" alt="Logo" height="100px" />
                <span class="d-none d-lg-block"> Krushna Logistics Company</span>
            </a>
...
<li class="nav-item dropdown pe-3">
    ...
    <?php $this->rendersection('profilename') ?>
        ...
        <li>
            <a class="dropdown-item d-flex align-items-center" href="<?= base_url() ?>/trpadmin/login">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="trpadmin/user/index">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Krushna</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
...
<script src="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/alertify.min.js"></script>
    ...
    <script>
        ...
        var myLineChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "Octomber", "November", "Decmber"],
                datasets: [{
                    label: "Revenue",
